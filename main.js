...
setIndexContact: function (index) {
    ...
    console.log(`l'indice è diventato ${this.indexContact}`)
},
...
newMessage: function () {
    ...
    this.contacts[this.indexContact].messages.push(newMessageObj)

    setTimeout(
        () => {

            this.contacts[this.indexContact].messages.push(newMessageReceived);
        }, 1000
    );
},
...
filterContacts: function (e) { // filtra contatti con input
    let searchN = this.Search.toLowerCase();
    let filterN = e.name.toLowerCase();
